...
// Package lsp contains data types and code for LSP jsonrpcs
...
type WorkspaceEdit struct {
	 ...
	 */
	DocumentChanges []interface{} /* []TextDocumentEdit | CreateFile | RenameFile | DeleteFile*/ `json:"documentChanges,omitempty"`
	/**
